...
describe("UserEntity", () => {
  describe("constructor", () => {
    ...
    it("should throw InvalidParamError for missing name", () => {
      ...
      expect(
        () =>
          new UserEntity({ email: "teste@gmail.com", password: "senha12345" })
    ...
    it("should throw InvalidParamError for missing email", () => {
      ...
      expect(
        () => new UserEntity({ name: "User 1", password: "senha12345" })
      ).toThrow(InvalidParamError);
    });
    ...
    it("should throw InvalidParamError for missing password", () => {
      ...
      expect(
        () => new UserEntity({ email: "teste@gmail.com", name: "User 1" })
      ).toThrow(InvalidParamError);
    });
    ...
    it("should throw InvalidParamError for multiple missing parameters", () => {
      ...
      expect(() => new UserEntity({ email: "teste@gmail.com" })).toThrow(
        InvalidParamError
      );
    });
