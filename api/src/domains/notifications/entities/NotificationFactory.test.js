...
describe("NotificationEntity", () => {
  describe("constructor", () => {
    ...
    it("should throw InvalidParamError for missing from", () => {
      ...
      expect(() => new NotificationEntity({ to: 2 })).toThrow(
        InvalidParamError
      );
    });
    ...
    it("should throw InvalidParamError for missing to", () => {
      ...
      expect(() => new NotificationEntity({ from: 1 })).toThrow(
        InvalidParamError
      );
    });
    ...
    it("should throw InvalidParamError for typeof from", () => {
      ...
      expect(() => new NotificationEntity({ from: "1", name: 2 })).toThrow(
        InvalidParamError
      );
    });
    ...
    it("should throw InvalidParamError for typeof to", () => {
      ...
      expect(() => new NotificationEntity({ from: 1, to: "2" })).toThrow(
        InvalidParamError
      );
    });
    ...
    it("should throw InvalidParamError for multiple missing parameters", () => {
      ...
      expect(() => new NotificationEntity({})).toThrow(InvalidParamError);
    });
    ...
    it("should throw InvalidParamError for equal from and to", () => {
      const NotificationEntity = NotificationFactory({ InvalidParamError });

      expect(() => new NotificationEntity({ from: 1, to: 1 })).toThrow(
        InvalidParamError
      );
    });
    ...
    it("should throw InvalidParamError for from less than 1", () => {
      ...
      expect(() => new NotificationEntity({ from: 0, to: 2 })).toThrow(
        InvalidParamError
      );
    });
    ...
    it("should throw InvalidParamError for to less than 1", () => {
      ...
      expect(() => new NotificationEntity({ from: 1, to: 0 })).toThrow(
        InvalidParamError
      );
    });

    it("should throw InvalidParamError for from and to less than 1", () => {
      const NotificationEntity = NotificationFactory({ InvalidParamError });
